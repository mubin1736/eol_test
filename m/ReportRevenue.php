			...
			<div class="box-body aasas"> 
				...
				<form id="" name="form" class="stdform" method="post" action="fpdf/ReportRevenue" target="_blank">
					...
					<div class="inputwrapper1 animate_cus4">
						<input type="text" name="f_date" id="" class="datepicker" style="width: 40%;" placeholder="From Date"/>
						<input type="text" name="t_date" id="" class="datepicker" style="width: 40%;" placeholder="To Date"/>
					</div>
